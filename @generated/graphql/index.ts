...
export type ProductGallery_ProductsFragment = {
  pageInfo: { totalCount: number }
}

export type ProductGallery_FacetsFragment = {
  key: string
  label: string
  type: StoreFacetType
  values: Array<{
...
export type CollectionSearchQueryQuery = {
  search: {
    products: {
      edges: Array<{
        node: {
...
export type FullTextSearchQueryQuery = {
  search: {
    products: {
      edges: Array<{
        node: {
